...
resource "aws_flow_log" "aws-demo6" {
  vpc_id          = "${aws_vpc.aws-demo6.id}"
  iam_role_arn    = "<iam_role_arn>"
  log_destination = "${aws_s3_bucket.aws-demo6.arn}"
  traffic_type    = "ALL"

  tags = {
    GeneratedBy      = "Accurics"
    ParentResourceId = "aws_vpc.aws-demo6"
  }
}
resource "aws_s3_bucket" "aws-demo6" {
  bucket        = "aws-demo6_flow_log_s3_bucket"
  acl           = "private"
  force_destroy = true
...
resource "aws_s3_bucket_policy" "aws-demo6" {
  bucket = "${aws_s3_bucket.aws-demo6.id}"
  ...
  policy = <<POLICY
{
  ...
  "Statement": [
    {
      "Sid": "aws-demo6-restrict-access-to-users-or-roles",
      "Effect": "Allow",
      "Principal": [
        {
          "AWS": [
      ...
      "Action": "s3:GetObject",
      "Resource": "arn:aws:s3:::${aws_s3_bucket.aws-demo6.id}/*"
    }
  ]
}
POLICY
}
resource "aws_flow_log" "aws-demo7" {
  vpc_id          = "${aws_vpc.aws-demo7.id}"
  iam_role_arn    = "<iam_role_arn>"
  log_destination = "${aws_s3_bucket.aws-demo7.arn}"
  traffic_type    = "ALL"

  tags = {
    GeneratedBy      = "Accurics"
    ParentResourceId = "aws_vpc.aws-demo7"
  }
}
resource "aws_s3_bucket" "aws-demo7" {
  bucket        = "aws-demo7_flow_log_s3_bucket"
  acl           = "private"
  force_destroy = true
...
resource "aws_s3_bucket_policy" "aws-demo7" {
  bucket = "${aws_s3_bucket.aws-demo7.id}"
  ...
  policy = <<POLICY
{
  ...
  "Statement": [
    {
      "Sid": "aws-demo7-restrict-access-to-users-or-roles",
      "Effect": "Allow",
      "Principal": [
        {
          "AWS": [
      ...
      "Action": "s3:GetObject",
      "Resource": "arn:aws:s3:::${aws_s3_bucket.aws-demo7.id}/*"
    }
  ]
}
POLICY
}
resource "aws_flow_log" "aws-demo8" {
  vpc_id          = "${aws_vpc.aws-demo8.id}"
  iam_role_arn    = "<iam_role_arn>"
  log_destination = "${aws_s3_bucket.aws-demo8.arn}"
  traffic_type    = "ALL"

  tags = {
    GeneratedBy      = "Accurics"
    ParentResourceId = "aws_vpc.aws-demo8"
  }
}
resource "aws_s3_bucket" "aws-demo8" {
  bucket        = "aws-demo8_flow_log_s3_bucket"
  acl           = "private"
  force_destroy = true
...
resource "aws_s3_bucket_policy" "aws-demo8" {
  bucket = "${aws_s3_bucket.aws-demo8.id}"
  ...
  policy = <<POLICY
{
  ...
  "Statement": [
    {
      "Sid": "aws-demo8-restrict-access-to-users-or-roles",
      "Effect": "Allow",
      "Principal": [
        {
          "AWS": [
      ...
      "Action": "s3:GetObject",
      "Resource": "arn:aws:s3:::${aws_s3_bucket.aws-demo8.id}/*"
    }
  ]
}
POLICY
